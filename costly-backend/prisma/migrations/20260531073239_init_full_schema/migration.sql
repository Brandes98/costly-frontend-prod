...
CREATE TABLE "producto" (
    ...
    "isc_pct" DECIMAL(5,2),
    "peso_kg" DECIMAL(18,3),
    "largo_cm" DECIMAL(18,2),
    "ancho_cm" DECIMAL(18,2),
    "alto_cm" DECIMAL(18,2),
    "volumen_m3" DECIMAL(18,6),
    "modo_volumen" VARCHAR(20) DEFAULT 'unitario',
    "unidades_por_caja" INTEGER,
    "peso_caja_kg" DECIMAL(18,3),
    "largo_caja_cm" DECIMAL(18,2),
    "ancho_caja_cm" DECIMAL(18,2),
    "alto_caja_cm" DECIMAL(18,2),
    "volumen_caja_m3" DECIMAL(18,6),
    "tipo_estiba" "TipoEstiba" NOT NULL DEFAULT 'pallet_americano',
    "pallet_largo_cm" DECIMAL(18,2),
    "pallet_ancho_cm" DECIMAL(18,2),
    "pallet_alto_max_cm" DECIMAL(18,2),
    "pallet_peso_max_kg" DECIMAL(18,3),
    "nota_estiba" TEXT,
...
CREATE TABLE "costeo_importacion" (
    ...
    CONSTRAINT "costeo_importacion_pkey" PRIMARY KEY ("ci_id")
);
...
CREATE TABLE "costeo_detalle" (
    ...
    CONSTRAINT "costeo_detalle_pkey" PRIMARY KEY ("detalle_id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "costeo_importacion_costeo_id_importacion_id_key" ON "costeo_importacion"("costeo_id", "importacion_id");

-- CreateIndex
CREATE UNIQUE INDEX "costeo_detalle_costeo_id_campo_key" ON "costeo_detalle"("costeo_id", "campo");
...
-- AddForeignKey
ALTER TABLE "costeo" ADD CONSTRAINT "costeo_importacion_id_fkey" FOREIGN KEY ("importacion_id") REFERENCES "importacion"("importacion_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "costeo_importacion" ADD CONSTRAINT "costeo_importacion_costeo_id_fkey" FOREIGN KEY ("costeo_id") REFERENCES "costeo"("costeo_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "costeo_importacion" ADD CONSTRAINT "costeo_importacion_importacion_id_fkey" FOREIGN KEY ("importacion_id") REFERENCES "importacion"("importacion_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "costeo_detalle" ADD CONSTRAINT "costeo_detalle_costeo_id_fkey" FOREIGN KEY ("costeo_id") REFERENCES "costeo"("costeo_id") ON DELETE CASCADE ON UPDATE CASCADE;
